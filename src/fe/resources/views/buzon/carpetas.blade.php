...
@section('content_header')
    <div class="row">
        <div class="col-10">
            <div class="row">
                <div class="col-md-7"><div class="form-group"><h1>Buzón: {{$nombre_buzon}}</h1></div></div>
                <div class="col-md-4">
...
<script>
    ...
    function firmar_documento()
    {
        ...
        $('input:checkbox[name="chkFirmaAnexo"]:checked').each(function(){            
            if (this.checked) {
                aParaFirma.push($(this).val());
                hayAnexos = " y anexos seleccionados";
            }
        }); 
        ...
        Swal.fire({
                title: 'Firmar',
                html: "Se realizará la firma del documento: "+ hayAnexos +"<br>" +
                    "<b>" + $("input[name='materia']").val() + "</b><br>",
                showCancelButton: true,
                cancelButtonText: 'Cancelar',
                confirmButtonColor: '#3085d6',
                    ...
                    if(data.status=='200')
                    {
                        ...
                        { 
                            ...
                            else
                            {
                                ...
                                chkFirmaAnexo += '<input type="checkbox" name="chkFirmaAnexo" value="'+value.id_documento_buzon_archivo+'-2" style="position: absolute;top: 23px;left: 80px;">';
    ...
    function grilla_por_recibir_texto(sTexto){
        ...
        grilla_por_recibir=  $('#grilla_por_recibir').DataTable({
                processing: true,
                serverSide: true,
                ajax: '/buzonesListar?id_buzon={{$id_buzon}}&id_carpeta=1&texto='+sTexto,
                type:'json',
                responsive: true,
    ...
    function grillas_despachados_texto(stexto){
        ...
        grilla_despachados=  $('#grilla_despachados').DataTable({
            processing: true,
            serverSide: true,
            ajax: '/buzonesListar?id_buzon={{$id_buzon}}&id_carpeta=3&texto='+stexto,
            type:'json',
            order: [[ 2, 'desc' ]],  
            responsive: true,
            language: lenguaje_datatable,
