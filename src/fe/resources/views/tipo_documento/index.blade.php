...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("form_plantilla_distribucion"), {
            toolbar: {
                items: [
                    'heading', '|',
    ...
    let editor_cuerpo;
    CKEDITOR.ClassicEditor.create(document.getElementById("form_plantilla_cuerpo"), {
            toolbar: {
                items: [
                    'heading', '|',
                    'bold', 'italic', 'strikethrough', 'underline', 'code', 'subscript', 'superscript', 'removeFormat', '|',
    ...
    let editor_encabezado;
    CKEDITOR.ClassicEditor.create(document.getElementById("form_plantilla_encabezado"), {
            toolbar: {
                items: [
                    'heading', '|',
                    'bold', 'italic', 'strikethrough', 'underline', 'code', 'subscript', 'superscript', 'removeFormat', '|',
    ...
    */
    ...
    function ver_tipodoc(id, op) {
        ...
        if (op == 2) {
            ...
            editor_encabezado.disableReadOnlyMode('ee');
            $('#titulo_crear_editar').html('Editar Tipo de Documento');
            $('.form-control').prop("disabled", false);
            $('.btn-submit').show();
            $('#selectPrimera').select2({
                width: 'resolve'
            });
            $('#selectSegunda').select2({
                width: 'resolve'
            });
        } else {
            ...
            editor_encabezado.enableReadOnlyMode('ee');
    ...
    function activa_firmas(re) {
        if (re == "true") {
            ...
            $('#opDerivacion').hide();
            $('#selectPrimera').val(null).trigger('change');
