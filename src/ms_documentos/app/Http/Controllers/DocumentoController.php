        ...
        if($request->isJson())
        {
            try
            {
                ...
                if( $datosTipoDoc->id_tipo_asignacion_folio == 1) //creación
                    $datosDocumento['folio'] = 'asignar folio'; //servicio folio

                //asignar valores
                $datosDocumento['fecha'] = date('Y-m-d H:i:s');
                $datosDocumento['identificador'] = '99999';
                $datosDocumento['hash_validacion'] = 'XYZ999';
                
                
                return $datosDocumento;         
                $documento = Documento::create($datosDocumento);              
               /* $documento = Documento::create([
                    'id_tipo_documento' => $datosDocumento['materia'],
